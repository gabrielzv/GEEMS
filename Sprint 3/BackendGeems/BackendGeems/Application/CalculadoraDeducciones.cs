...
namespace BackendGeems.Application
{
    public class CalculadoraDeducciones : ICalculadoraDeducciones
    {
        public ResultadoDeducciones Calcular(decimal salarioBruto)
        {
            ...
            {
                new DetalleDeduccion { Nombre = "SEM (Enfermedad/Maternidad)", Porcentaje = 0.0525m },
                new DetalleDeduccion { Nombre = "IVM (Invalidez, Vejez y Muerte)", Porcentaje = 0.0384m },
                ...
                new DetalleDeduccion { Nombre = "Aporte Banco Popular", Porcentaje = 0.0025m },
